...
!function(t, e) {
    ...
    function W(t) {
        return C(t) ? t : M(t) || A(t) ? t[0] : k(t) ? W(t[0]) : null
    }
    function V(t) {
        return C(t) ? [t] : M(t) ? m.slice.call(t) : k(t) ? t.map(W).filter(Boolean) : A(t) ? t.toArray() : []
    }
    function R(t) {
    ...
    var lt = /msie|trident/i.test(window.navigator.userAgent)
      ...
      , ft = ct || window.DocumentTouch && document instanceof DocumentTouch || navigator.maxTouchPoints
    ...
    function Dt(t, e) {
        ...
        N(t) ? zt.call(t, e) : V(t).map(function(t) {
            return Dt(t, e)
        }).filter(Boolean)
    }
    function Pt(t) {
    ...
    var Ht = window.CSS && CSS.escape || function(t) {
    ...
    function Yt(t, e) {
        return D(e) ? Mt(t, e) || Dt(t, e) : t === e || (_(e) ? e.documentElement : W(e)).contains(W(t))
    }
    function Ut() {
        for (var t = [], e = arguments.length; e--; )
            t[e] = arguments[e];
        var i, n, r = Zt(t), o = r[0], s = r[1], a = r[2], h = r[3], l = r[4];
        return o = ie(o),
        1 < h.length && (i = h,
        h = function(t) {
    ...
    function me(t, e, i, n) {
        ...
        void 0 === n && (n = !1);
        var r = (e = V(e)).length;
        return t = B(t) ? F(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : pe(e, t),
        n ? tt(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    function ge(t) {
        return (t = Ce(t)).innerHTML = "",
        t
    }
    function ve(t, e) {
        return t = Ce(t),
    ...
    function ye(t, e) {
        return (t = D(t) ? _e(t) : t) ? "length"in t ? V(t).map(e) : e(t) : null
    }
    function ke(t) {
        V(t).map(function(t) {
    ...
    function _e(t) {
        ...
        return Te.test(t) ? i.insertAdjacentHTML("beforeend", t.trim()) : i.textContent = t,
    ...
    function Ce(t, e) {
        return D(t) ? Me(t) ? W(_e(t)) : $t(t, e) : W(t)
    }
    function Ne(t, e) {
        return D(t) ? Me(t) ? V(_e(t)) : It(t, e) : V(t)
    }
    function Me(t) {
    ...
    function Ve(t, e, r) {
        return V(t).map(function(i) {
            if (D(e)) {
                ...
                H(r))
                    return qe(i, e);
                r || P(r) ? i.style[e] = B(r) && !We[e] ? r + "px" : r : i.style.removeProperty(e)
            } else {
                if (k(e)) {
                    var n = Re(i);
    ...
    function Ue(t) {
        ...
        if (!lt)
            return Re(e).getPropertyValue("--uk-" + t);
        if (!(t in Ye)) {
            var i = we(e, document.createElement("div"));
            ze(i, "uk-" + t),
            Ye[t] = qe(i, "content", ":before").replace(/^["'](.*)["']$/, "$1"),
            ke(i)
        }
        return Ye[t]
    }
        ...
        se.all(V(t).map(function(s) {
            return new se(function(n, r) {
                if (Oe(s, ti))
                    ...
                    w(e, Qe) && (a && (t += " uk-transform-origin-" + a),
                    h && (t += " " + Qe + "reverse")),
                    o(),
                    Gt(s, "animationend animationcancel", function(t) {
                        var e = t.type
                          , i = !1;
                        "animationcancel" === e ? (r(),
                        o()) : (n(),
    ...
    function ai(t) {
        ...
        Wt(t) || "none" !== Ve(t, "display") || (e = ot(t, "style"),
        i = ot(t, "hidden"),
        ot(t, {
    ...
    function fi(i, t, e) {
        ...
        Ve(i, "boxSizing") === e ? ri[t].slice(1).map(p).reduce(function(t, e) {
    ...
    function wi(t, e, i) {
        ...
        void 0 === i && (i = window),
        B(t) ? +t : u(t, "vh") ? bi(ui(R(i)), t) : u(t, "vw") ? bi(ci(R(i)), t) : u(t, "%") ? bi(ai(i)[e], t) : j(t)
    }
    function bi(t, e) {
        return t * j(e) / 100
    }
    ...
    Ei.events = Ei.created = Ei.beforeConnect = Ei.connected = Ei.beforeDisconnect = Ei.disconnected = Ei.destroy = Ai,
    ...
    function Oi(t, e) {
        ...
        Wt(t)) {
            var u = ji(t).concat(t);
            h /= u.length - 1;
            for (var i = se.resolve(), n = function(e) {
                i = i.then(function() {
                    return new se(function(i) {
                        var n = u[e]
                          ...
                          , s = Date.now()
                          , a = function() {
                            var t, e = (t = tt((Date.now() - s) / h),
                            .5 * (1 - Math.cos(Math.PI * t)));
                            Bi(n, r + o * e),
                            1 != e ? requestAnimationFrame(a) : i()
                        };
                        a()
                    }
                    )
    ...
    var Vi = "IntersectionObserver"in window ? window.IntersectionObserver : function() {
        function t(e, t) {
            ...
            ,
            this.off = Ut(window, "scroll resize load", this.apply, {
                passive: !0,
                capture: !0
            })
        }
    ...
    function on(e, i, n) {
        ...
        }) : !r || l && !l.call(e) || e._events.push(Ut(r, t, h ? D(h) ? h : h.call(e) : null, D(o) ? e[o] : o.bind(e), {
            passive: a,
            capture: s,
            self: u
        }))
    ...
    qi.util = Object.freeze({
        ...
        prepend: function(e, t) {
            return (e = Ce(e)).hasChildNodes() ? ye(t, function(t) {
    ...
    Yi.mixin = function(t, e) {
        (e = (D(e) ? Yi.component(e) : e) || this).options = Ci(e.options, t)
    }
    ,
    Yi.extend = function(t) {
        ...
        return ((e.prototype = Object.create(this.prototype)).constructor = e).options = Ci(this.options, t),
        e.super = this,
    ...
    Yi.update = function(t, e) {
        Bt(t = t ? W(t) : document.body).reverse().forEach(function(t) {
            return en(t[Xi], e)
        }),
        Ae(t, function(t) {
            return en(t[Xi], e)
    ...
    ,
    Ki.prototype._initWatches = function() {
        var t = this.$options.computed;
        if (t)
            for (var e in t) {
                var i = t[e]
    ...
    Ki.prototype._callWatches = function() {
        ...
        for (var i in e) {
            var n = e[i];
            delete e[i],
            t[i].watch && !U(n, this[i]) && t[i].watch.call(this, this[i], n)
        }
    }
    ,
        ...
        methods: {
            toggleElement: function(l, u, c) {
                ...
                return new se(function(t) {
                    ...
                    var i;
                    if (d.queued && H(c) && H(u) && d.hasAnimation && !(l.length < 2)) {
            ...
            _toggleElement: function(t, e, i) {
                var n = this;
                if (e = z(e) ? e : ni.inProgress(t) ? Oe(t, "uk-animation-leave") : Ze.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t),
                !Kt(t, "before" + (e ? "show" : "hide"), [this]))
                    return se.reject();
                var r, o, s, a, h, l, u, c, d, f, p, m, g = ($(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? (u = (l = this).isToggled,
                c = l.duration,
                d = l.initProps,
                f = l.hideProps,
                p = l.transition,
                ...
                function(t, e) {
                    ...
                    (e ? Ze.start(t, G({}, d, {
                        overflow: "hidden",
                        height: o
                    }), Math.round(c * (1 - r / o)), p) : Ze.start(t, f, Math.round(c * (r / o)), p).then(function() {
                        return m(t, !1)
                    })).then(function() {
                        return Ve(t, d)
                    })
                ...
                function(t, e) {
                    return ni.cancel(t),
                    e ? (h(t, !0),
                    ni.in(t, o[0], s, a)) : ni.out(t, o[1] || o[0], s, a).then(function() {
                        return h(t, !1)
                    })
                }
                ) : this._toggle)(t, e);
    ...
    var un = {
            ...
            items: {
                ...
                watch: function(t, e) {
                    ...
                    if (t.forEach(function(t) {
                        return i._toggle(Ce(i.content, t), Oe(t, i.clsOpen))
                    }),
                    !Oe(t, this.clsOpen)) {
                        var n = !e && !1 !== this.active && t[Number(this.active)] || !this.collapsible && t[0];
                        n && this.toggle(n, !1)
                    }
                },
                immediate: !0
        ...
        events: [{
            ...
            handler: function(t) {
                t.preventDefault(),
                this.toggle(pe(Ne(this.targets + " " + this.$props.toggle, this.$el), t.current))
            }
        }],
        methods: {
            toggle: function(r, o) {
                ...
                (r = this.items[t]) && [r].concat(!this.multiple && !b(a, r) && a || []).forEach(function(e) {
                    var t = e === r
                      , i = t && !Oe(e, s.clsOpen);
                    if (i || !t || s.collapsible || !(a.length < 2)) {
                        He(e, s.clsOpen, i);
                        var n = e._wrapper ? e._wrapper.firstElementChild : Ce(s.content, e);
                        e._wrapper || (e._wrapper = $e(n, "<div>"),
                        ot(e._wrapper, "hidden", i ? "" : null)),
                        s._toggle(n, !0),
                        s.toggleElement(e._wrapper, i, o).then(function() {
                            if (Oe(e, s.clsOpen) === i) {
                                if (i) {
                                    var t = Ce(s.$props.toggle, e);
                                    !1 === o || Pi(t) || Oi(t)
                                } else
                                    s._toggle(n, !1);
                                e._wrapper = null,
      ...
      , dn = {
        ...
        update: {
            read: function() {
                return !!this.player && {
                    visible: Wt(this.$el) && "hidden" !== Ve(this.$el, "visibility"),
    ...
    var pn, mn = {
        ...
        methods: {
            positionAt: function(t, e, i) {
                ...
                var r = this.offset
                  , o = this.getAxis();
                B(r) || (r = (n = Ce(r)) ? si(n)["x" === o ? "left" : "top"] - si(e)["x" === o ? "right" : "bottom"] : 0);
        ...
        events: [{
            ...
            handler: function() {
                ...
                var t = vn(document, "click", function(t) {
                    var e = t.defaultPrevented
                      , i = t.target;
            ...
            handler: function(t) {
                ...
                Kt(this.$el, "updatearia"),
                this.tracker.cancel()) : pn = null === pn && Yt(e, this.$el) && this.isToggled() ? this : pn
            }
        }, {
            name: "updatearia",
            self: !0,
            handler: function(t, e) {
                ...
                He(this.toggle.$el, this.cls, this.isToggled()))
            }
        }],
        update: {
            write: function() {
        ...
        methods: {
            ...
            position: function() {
                ...
                if ("justify" === this.align) {
                    ...
                    this.$el.offsetWidth > Math.max(t.right - e.left, e.right - t.left) && ze(this.$el, this.clsDrop + "-stack");
      ...
      , bn = {
        ...
        update: function() {
            var t = this.target
              , e = this.input;
            if (t) {
                var i, n = Rt(t) ? "value" : "textContent", r = t[n], o = e.files && e.files[0] ? e.files[0].name : Mt(e, "select") && (i = Ne("option", e).filter(function(t) {
                    return t.selected
        ...
        for (var e = [[]], i = 0; i < t.length; i++) {
            ...
            if (r.height)
                for (var o = e.length - 1; 0 <= o; o--) {
                    ...
                    var a = void 0;
                    if (a = s[0].offsetParent === n.offsetParent ? $n(s[0]) : (r = $n(n, !0),
                    $n(s[0], !0)),
    ...
    var In = {
        ...
        update: [{
                ...
                if (this.masonry && this.length) {
                    ...
                    h = r.reduce(function(i, t, n) {
                        return i[n] = t.map(function(t, e) {
                            return 0 === n ? 0 : j(i[n - 1][e]) + (u - j(r[n - 1][e] && r[n - 1][e].offsetHeight))
                        }),
                    ...
                    padding: this.parallax && function(t, e, i) {
                        for (var n = 0, r = 0, o = 0, s = e.length - 1; 0 <= s; s--)
                            for (var a = n; a < e[s].length; a++) {
                                var h = e[s][a]
                                  , l = h.offsetTop + ui(h) + (i && -i[s][a]);
                                r = Math.max(r, l),
                                o = Math.max(o, l + (a % 2 ? t : t / 8)),
                                n++
                            }
                        return o - r
                    }(this.parallax, r, h),
            ...
            read: function(t) {
                var e = t.height;
                return {
                    scrolled: !!this.parallax && Hi(this.$el, e ? e - ui(this.$el) : 0) * this.parallax
                }
            },
            write: function(t) {
                var e = t.rows
            ...
            read: function(t) {
                ...
                if (this.expand) {
                    ...
                    Ce("[data-height-expand]") !== this.$el)
                        return !1;
                    i = ui(window) - (Cn(document.documentElement) - Cn(this.$el)) - n || ""
                } else {
                    if (i = "calc(100vh",
                    this.offsetTop) {
                        var r = si(this.$el).top;
                        i += 0 < r && r < ui(window) / 2 ? " - " + r + "px" : ""
                    }
                    !0 === this.offsetBottom ? i += " - " + Cn(this.$el.nextElementSibling) + "px" : B(this.offsetBottom) ? i += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? i += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (i += " - " + Cn(xt(this.offsetBottom, this.$el)) + "px"),
                    i += (n ? " - " + n + "px" : "") + ")"
                }
                return {
                    minHeight: i,
    ...
    var Nn = {
                ...
                e.svgEl = function(t, e) {
                    {
                        if (jt(e) || "CANVAS" === e.tagName) {
                            ...
                            return Bn(t, i) ? i : xe(e, t)
                        }
                        var n = e.lastElementChild;
                        return Bn(t, n) ? n : we(e, t)
                    }
                }(t, e.$el)
            }, et)
        },
        ...
        update: {
            read: function() {
                return !!(this.strokeAnimation && this.svgEl && Wt(this.svgEl))
            },
            write: function() {
                var t, e;
                t = this.svgEl,
            ...
            getSvg: function() {
                ...
                return function(i) {
                    ...
                    return Mn[i] = new se(function(e, t) {
                        i ? w(i, "data:") ? e(decodeURIComponent(i.split(",")[1])) : ce(i).then(function(t) {
                            return e(t.response)
                        }, function() {
                    ...
                    return function(t, e) {
                        e && b(t, "<symbol") && (t = function(t, e) {
                            if (!Dn[t]) {
                                var i;
                                for (Dn[t] = {}; i = zn.exec(t); )
                                    Dn[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>";
                                zn.lastIndex = 0
                            }
                            return Dn[t][e]
                        }(t, e) || t);
                        return (t = Ce(t.substr(t.indexOf("<svg")))) && t.hasChildNodes() && t
    ...
    var zn = /<symbol(.*?id=(['"])(.*?)\2[^]*?<\/)symbol>/g
      , Dn = {};
    function Pn(t) {
        return Math.ceil(Math.max.apply(Math, Ne("[stroke]", t).map(function(t) {
    ...
    var On = {}
        ...
        methods: {
            getSvg: function() {
                var t, e = function(t) {
                    if (!Hn[t])
                        return null;
                    On[t] || (On[t] = Ce(Hn[t].trim()));
                    return On[t].cloneNode(!0)
                }((t = this.icon,
                ut ? X(X(t, "left", "right"), "previous", "next") : t));
      ...
      , Wn = {
        ...
        computed: {
            icon: function(t, e) {
                var i = t.icon;
                return Oe(e, "uk-search-icon") && Bt(e, ".uk-search-large").length ? "search-large" : Bt(e, ".uk-search-navbar").length ? "search-navbar" : i
            }
        }
    }
      , Vn = {
      ...
      , Rn = {
        ...
        connected: function() {
            ...
            this.svg.then(function(t) {
                return 1 !== e.ratio && Ve(Ce("circle", t), "strokeWidth", 1 / e.ratio)
            }, et)
        }
    };
    var qn = {
        ...
        connected: function() {
            tr[this.cacheKey] ? Yn(this.$el, tr[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && Yn(this.$el, function(t, e, i) {
                var n;
                i && (n = rt.ratio({
                    width: t,
                    height: e
        ...
        update: {
            read: function(t) {
                ...
                this.isImg)
                    return !1;
                i && i.then(function(t) {
                    return t && "" !== t.currentSrc && Yn(e.$el, Qn(t))
                })
            },
            write: function(t) {
        ...
        methods: {
            load: function(t) {
                ...
                t.some(function(t) {
                    ...
                    return Yn(e.$el, Qn(t), t.srcset, t.sizes),
                    tr[e.cacheKey] = Qn(t),
                    t
                }, et),
                this.observer.disconnect())
    ...
    function Yn(t, e, i, n) {
        if (Zn(t))
            ...
            !b(t.style.backgroundImage, e) && (Ve(t, "backgroundImage", "url(" + Lt(e) + ")"),
            Kt(t, Jt("load", !1)))
        }
    }
    ...
    var nr = {
      ...
      , sr = {
        ...
        events: [{
            ...
            handler: function() {
                var r = this;
                ci(window) - ci(document) && this.overlay && Ve(document.body, "overflowY", "scroll"),
                ze(document.documentElement, this.clsPage),
                this.bgClose && Gt(this.$el, "hide", vn(document, "click", function(t) {
                    var e = t.defaultPrevented
                      , i = t.target
                      , n = K(or);
                    e || n !== r || n.overlay && !Yt(i, n.$el) || Yt(i, n.panel) || n.hide()
                }), {
                    self: !0
                }),
                this.escClose && Gt(this.$el, "hide", Ut(document, "keydown", function(t) {
                    var e = K(or);
                    27 === t.keyCode && e === r && (t.preventDefault(),
                    e.hide())
                }), {
                    self: !0
                })
        ...
        methods: {
            ...
            show: function() {
                var e = this;
                return this.container && this.$el.parentNode !== this.container ? (we(this.container, this.$el),
                new se(function(t) {
    ...
    var hr = {
        install: function(a) {
            ...
            a.modal.alert = function(e, i) {
                ...
                new se(function(t) {
                    return Ut(a.modal.dialog(' <div class="uk-modal-body">' + (D(e) ? e : ve(e)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>' + i.labels.ok + "</button> </div> ", i).$el, "hide", t)
                }
                )
            }
            ,
            a.modal.confirm = function(r, o) {
                ...
                new se(function(e, t) {
                    var i = a.modal.dialog(' <form> <div class="uk-modal-body">' + (D(r) ? r : ve(r)) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">' + o.labels.cancel + '</button> <button class="uk-button uk-button-primary" autofocus>' + o.labels.ok + "</button> </div> </form> ", o)
                      , n = !1;
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                Oe(this.panel, "uk-margin-auto-vertical") ? ze(this.$el, "uk-flex") : Ve(this.$el, "display", "block"),
                ui(this.$el)
            }
        }, {
            name: "hidden",
      ...
      , ur = {
        ...
        computed: {
            ...
            dropbar: {
                get: function(t) {
                    var e = t.dropbar;
                    return e ? (e = this._dropbar || xt(e, this.$el) || Ce("+ .uk-navbar-dropbar", this.$el)) || (this._dropbar = Ce("<div></div>")) : null
                },
                watch: function(t) {
                    ze(t, "uk-navbar-dropbar"),
                    He(t, "uk-navbar-dropbar-slide", "slide" === this.dropbarMode)
                },
                immediate: !0
            },
            dropdowns: {
        ...
        events: [{
            ...
            handler: function(t) {
                var e = t.current
                  , i = this.getActive();
                i && i.toggle && !Yt(i.toggle.$el, e) && !i.tracker.movesTo(i.$el) && i.hide(!1)
            }
        }, {
            name: "mouseleave",
            el: function() {
        ...
        methods: {
            getActive: function() {
                ...
                return t && b(t.mode, "hover") && Yt(t.toggle.$el, this.$el) && t
            },
      ...
      , cr = {
        ...
        events: [{
            ...
            handler: function(t) {
                ...
                !t.defaultPrevented && e && Ce(e, document.body) && this.hide()
            }
        }, {
            name: "touchstart",
            passive: !0,
            ...
            self: !0,
            handler: function() {
                "reveal" !== this.mode || Oe(this.panel.parentNode, this.clsMode) || ($e(this.panel, "<div>"),
    ...
    function dr() {
        return Ce('meta[name="viewport"]', document.head) || we(document.head, '<meta name="viewport">')
    }
    var fr = {
        mixins: [hn],
        props: {
        ...
        update: {
            read: function() {
                return !(!this.content || !this.container) && {
                    ...
                    max: Math.max(150, ui(this.container) - (si(this.content).height - ui(this.$el)))
                }
            },
            write: function(t) {
                var e = t.current
                ...
                Math.round(e) !== Math.round(i) && Kt(this.$el, "resize")
            },
            events: ["resize"]
        }
    }
      , pr = {
        ...
        update: {
            read: function() {
                return !!(Wt(this.$el) && this.width && this.height) && {
                    width: ci(this.$el.parentNode),
                    height: this.height
                }
            },
            write: function(t) {
                ui(this.$el, rt.contain({
                    height: this.height,
                    width: this.width
                }, t).height)
            },
      ...
      , mr = {
        ...
        methods: {
            scrollTo: function(t) {
                ...
                Kt(this.$el, "beforescroll", [this, t]) && Oi(t, this.$props).then(function() {
        ...
        events: {
            click: function(t) {
                t.defaultPrevented || (t.preventDefault(),
                this.scrollTo(Lt(decodeURIComponent(this.$el.hash)).substr(1)))
            }
        }
    }
      , gr = {
        ...
        computed: {
            elements: {
                ...
                watch: function(t) {
                    this.hidden && Ve(qt(t, ":not(." + this.inViewClass + ")"), "visibility", "hidden")
                },
                immediate: !0
            }
        },
        update: [{
            ...
            write: function(n) {
                ...
                this.elements.forEach(function(e) {
                    ...
                    n.promise = (n.promise || se.resolve()).then(function() {
                        return new se(function(t) {
      ...
      , vr = {
        ...
        computed: {
            ...
            elements: function(t) {
                var e = t.closest;
                return Dt(Ne(this.targets.map(function(t) {
                    return '[href="#' + t.id + '"]'
                }).join(",")), e || "*")
            }
        },
      ...
      , wr = {
        ...
        computed: {
            ...
            isActive: {
                ...
                set: function(t) {
                    t && !this.isActive ? (Be(this.selTarget, this.clsInactive, this.clsActive),
                    Kt(this.$el, "active")) : t || Oe(this.selTarget, this.clsInactive) || (Be(this.selTarget, this.clsActive, this.clsInactive),
                    Kt(this.$el, "inactive"))
                }
            }
        },
        connected: function() {
            this.placeholder = Ce("+ .uk-sticky-placeholder", this.$el) || Ce('<div class="uk-sticky-placeholder"></div>'),
            this.isFixed = !1,
            this.isActive = !1
        },
        disconnected: function() {
                ...
                if (!1 !== this.targetOffset && location.hash && 0 < window.pageYOffset) {
                    ...
                    r && xi.read(function() {
                        var t = si(r).top
                          , e = si(n.$el).top
                          , i = n.$el.offsetHeight;
                        n.isFixed && t <= e + i && e <= t + r.offsetHeight && Bi(window, t - i - (B(n.targetOffset) ? n.targetOffset : 0) - n.offset)
                    })
                }
            }
        }],
        update: [{
            read: function(t, e) {
                ...
                return this.top = Math.max(j(br("top", this)), this.topOffset) - this.offset,
                this.bottom = n && n - i,
            ...
            read: function(t) {
                var e = t.scroll;
                return void 0 === e && (e = 0),
                this.width = (Wt(this.widthElement) ? this.widthElement : this.$el).offsetWidth,
            ...
            write: function(t, e) {
                ...
                var r = t.dir
                  ...
                  , l = t.visible
                  , u = performance.now();
                if (!((t.lastScroll = a) < 0 || a === s || !l || this.disabled || this.showOnUp && "scroll" !== e || ((300 < u - n || r !== o) && (t.initScroll = a,
                t.initTimestamp = u),
                t.lastDir = r,
    ...
    function br(t, e) {
        var i = e.$props
          ...
          , o = i[t];
        if (o)
            return B(o) && D(o) && o.match(/^-?\d/) ? r + wi(o) : si(!0 === o ? n.parentNode : xt(o, n)).bottom
    }
    var xr = {
        mixins: [ln],
        args: "connect",
        ...
        events: [{
            ...
            handler: function(e) {
                e.preventDefault(),
                this.show(Ot(this.$el).filter(function(t) {
        ...
        methods: {
            index: function() {
                return O(this.connects) ? -1 : pe(qt(this.connects[0].children, "." + this.cls)[0])
            },
            show: function(t) {
                for (var e, i, n = this, r = this.children, o = r.length, s = this.index(), a = 0 <= s, h = "previous" === t ? -1 : 1, l = me(t, r, s), u = 0; u < o; u++,
                l = (l + h + o) % o)
                    if (!Mt(this.toggles[l], ".uk-disabled *, .uk-disabled, [disabled]")) {
                        e = this.toggles[l],
                        i = r[l];
                        break
                    }
      ...
      , kr = {
        ...
        events: [{
            ...
            handler: function(t) {
                var e;
                (Dt(t.target, 'a[href="#"], a[href=""]') || (e = Dt(t.target, "a[href]")) && (this.cls && !Oe(this.target, this.cls.split(" ")[0]) || !Wt(this.target) || e.hash && Mt(this.target, e.hash))) && t.preventDefault(),
                this.toggle()
            }
        }],
        update: {
    ...
    var Sr, Tr = "uk-animation-target", Er = {
        props: {
            animation: Number
        },
        data: {
        ...
        methods: {
            animate: function(t) {
                ...
                var s = ui(this.target)
                  , a = (r = r.concat(Ot(this.target).filter(function(t) {
                    return !b(r, t)
                }))).map(function(t, e) {
                    return !!(t.parentNode && e in o) && (o[e] ? Wt(t) ? Cr(t) : {
                        opacity: 0
                    } : {
                        opacity: Wt(t) ? 1 : 0
                    })
                ...
                return o = a.map(function(t, e) {
                    var i = r[e].parentNode === n.target && (o[e] || _r(r[e]));
                    if (i)
                        if (t) {
                            if (!("opacity"in t)) {
                ...
                Bi(window, i),
                se.all(r.map(function(t, e) {
                    return o[e] && a[e] ? Ze.start(t, a[e], n.animation, "ease") : se.resolve()
                }).concat(Ze.start(this.target, {
                    height: s
    ...
    var Nr = {
        ...
        methods: {
            ...
            setState: function(l, t) {
                ...
                var c = this.children;
                this.toggles.forEach(function(t) {
                    return He(t, u.cls, !!function(t, e, i) {
                        var n = i.filter;
                        void 0 === n && (n = {
                            "": ""
                        });
                        ...
                        var u = a.sort
                          , c = a.order;
                        void 0 === c && (c = "asc");
                        return H(u) ? l in n && h === n[l] || !h && l && !(l in n) && !n[""] : o === u && s === c
                    }(t, u.attrItem, l))
                });
                function e() {
    ...
    var Fr = {
        mixins: [{
            ...
            methods: {
                startAutoplay: function() {
                    ...
                    this.stopAutoplay(),
                    this.interval = setInterval(function() {
                        return (!t.draggable || !Ce(":focus", t.$el)) && (!t.pauseOnHover || !Mt(t.$el, ":hover")) && !t.stack.length && t.show("next")
            ...
            events: [{
                ...
                handler: function(t) {
                    var e;
                    !this.draggable || !ne(t) && (!(e = t.target).children.length && e.childNodes.length) || Dt(t.target, Vt) || 0 < t.button || this.length < 2 || this.start(t)
                }
            }, {
                name: "touchmove",
                passive: !1,
            ...
            methods: {
                start: function() {
                    ...
                    var e = "touchmove" != mt ? Ut(document, mt, this.move, {
                        passive: !1
                    }) : et;
                ...
                move: function(t) {
                    ...
                    if (this.unbindMove) {
                        ...
                        if (!(0 == i || this.prevPos === this.pos || !this.dragging && Math.abs(i) < this.threshold)) {
                            ...
                            this.percent = o / a;
                            var h, l = n[r], u = n[s], c = this.index !== s, d = r === s;
                            ...
                            this._transitioner = this._translate(Math.abs(this.percent), l, !d && u),
                            c && (d || Kt(l, "itemhide", [this]),
                            Kt(u, "itemshow", [this]))
                        }
                    }
                },
                end: function() {
                    if (Xt(window, "scroll", this.unbindMove),
                    ...
                    this.dragging)
                        ...
                        this.index === this.prevIndex)
                            ...
                            var t = (ut ? this.dir * (ut ? 1 : -1) : this.dir) < 0 == this.prevPos > this.pos;
            ...
            update: {
                write: function() {
                    ...
                    He(Ne(this.selNavItem, this.$el).concat(this.nav), "uk-hidden", !this.maxIndex),
                    this.updateNav()
                },
                events: ["resize"]
            },
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(t) {
                        ...
                        He(t, "uk-invisible", i.finite && ("previous" === e && 0 === n || "next" === e && n >= i.maxIndex))
                    })
                }
            }
        }],
        ...
        methods: {
            ...
            _getTransitioner: function(t, e, i, n) {
                ...
                new this.Transitioner(P(t) ? this.slides[t] : t,P(e) ? this.slides[e] : e,i * (ut ? -1 : 1),n)
            }
        }
    };
    function jr(t) {
            ...
            Transitioner: function(o, s, a, t) {
                ...
                return {
                    ...
                    show: function(t, e, i) {
                        ...
                        se.all([Ze.start(s, l[1], t, r), Ze.start(o, l[0], t, r)]).then(function() {
                            n.reset(),
                            u.resolve()
                        }, et),
                        u.promise
      ...
      , Vr = {
        ...
        events: [{
            ...
            handler: function(t, r) {
                ...
                e)
                    if ("image" === i || e.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i))
                        de(e).then(function(t) {
                            return s.setItem(r, '<img width="' + t.width + '" height="' + t.height + '" src="' + e + '" alt="' + (n || "") + '">')
                        }, function() {
                            return s.setError(r)
                        });
                    else if ("video" === i || e.match(/\.(mp4|webm|ogv)($|\?)/i)) {
                        var a = Ce("<video controls playsinline" + (r.poster ? ' poster="' + r.poster + '"' : "") + ' uk-video="' + this.videoAutoplay + '"></video>');
                        ot(a, "src", e),
                        ...
                        var h = o[2]
                          , l = function(t, e) {
                            ...
                            void 0 === e && (e = 450),
                            s.setItem(r, Rr("https://www.youtube" + (o[1] || "") + ".com/embed/" + h, t, e, s.videoAutoplay))
                        };
                        ...
                        (o = e.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) && ce("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(e), {
                            responseType: "json",
                            withCredentials: !1
                        }).then(function(t) {
                            var e = t.response
    ...
    var qr, Yr = {
        ...
        computed: {
            ...
            items: function() {
                return Q(this.toggles.map(Ur), "source")
            }
        },
        disconnected: function() {
            this.hide()
        ...
        events: [{
            ...
            handler: function(t) {
                ...
                this.show(y(this.items, function(t) {
                    return t.source === e
                }))
            }
        }],
    ...
    function Ur(i) {
        return ["href", "caption", "type", "poster", "alt"].reduce(function(t, e) {
            return t["href" === e ? "source" : e] = ht(i, e),
            t
        }, {})
    }
    var Xr = {}
      , Gr = {
        ...
        created: function() {
            Xr[this.pos] || (Xr[this.pos] = we(this.$container, '<div class="uk-notification uk-notification-' + this.pos + '"></div>'));
            var t = Ve(Xr[this.pos], "display", "block");
        ...
        connected: function() {
            var t, e = this, i = j(Ve(this.$el, this.marginProp));
        ...
        events: ((qr = {
            click: function(t) {
                Dt(t.target, 'a[href="#"],a[href=""]') && t.preventDefault(),
                this.close()
            }
        })[vt] = function() {
        ...
        methods: {
            close: function(t) {
                function e() {
                    Kt(i.$el, "close", [i]),
                    ke(i.$el),
                    Xr[i.pos].children.length || Ve(Xr[i.pos], "display", "none")
                }
                var i = this;
                this.timer && clearTimeout(this.timer),
        ...
        computed: {
            props: function(m, g) {
                ...
                return Kr.reduce(function(t, e) {
                    if (H(m[e]))
                        return t;
                    var i, n, r, o = e.match(/color/i), s = o || "opacity" === e, a = m[e].slice(0);
                    s && Ve(g, e, ""),
                    a.length < 2 && a.unshift(("scale" === e ? 1 : s ? Ve(g, e) : 0) || 0);
                    ...
                    var i = d[e]
                      ...
                      , s = function(t, e, i) {
                        ...
                        var n = Zr(t, e)
                          ...
                          , o = n[1]
                          , s = n[2];
                        return (P(r) ? r + Math.abs(r - o) * s * (r < o ? 1 : -1) : +o).toFixed(i)
                    }(n, c);
                    switch (e) {
                    case "x":
                    case "y":
    ...
    var ao = {
        ...
        data: {
            ...
            Transitioner: function(r, n, o, t) {
                var e = t.center
                  ...
                  , l = n ? eo(n, a, e) : i + si(r).width * o * (ut ? -1 : 1);
                return {
                    dir: o,
                    show: function(t, e, i) {
                        void 0 === e && (e = 0);
                    ...
                    translate: function(t) {
                        ...
                        Ve(a, "transform", Br(tt(e - e * t - l, -no(a), si(a).width) * (ut ? -1 : 1), "px")),
                    ...
                    percent: function() {
                        return Math.abs((Ve(a, "transform").split(",")[4] * (ut ? -1 : 1) + i) / (l - i))
                    },
                    getDistance: function() {
                        return Math.abs(l - i)
                    },
        ...
        computed: {
            ...
            sets: function(t) {
                ...
                return !O(e = e && this.slides.reduce(function(t, e, i) {
                    ...
                    !b(t, i))) {
                        var r = o.slides[i + 1];
                        o.center && r && n < h - si(r).width / 2 ? h -= n : (h = s,
                        t.push(i),
        ...
        connected: function() {
            He(this.$el, this.clsContainer, !Ce("." + this.clsContainer, this.$el))
        },
        update: {
            write: function() {
                var i = this;
                Ne("[" + this.attrItem + "],[data-" + this.attrItem + "]", this.$el).forEach(function(t) {
                    var e = ht(t, i.attrItem);
                    i.maxIndex && He(t, "uk-hidden", B(e) && (i.sets && !b(i.sets, j(e)) || e > i.maxIndex))
                }),
        ...
        events: {
            beforeitemshow: function(t) {
                ...
                if (!this.dragging && 1 < e) {
                    ...
                    this.duration = jr(this.avgWidth / this.velocity) * (si(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth),
                    this.reorder()
            },
            itemshow: function() {
        ...
        events: [{
            ...
            handler: function(t) {
                var e = t.type
                  ...
                  , s = i.dir;
                Ze.cancel(this.$el),
                Ve(this.$el, this.getCss(uo(e, s, n))),
                Ze.start(this.$el, this.getCss(lo(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(et)
            }
        }, {
            ...
            handler: function(t) {
                var e = t.type
                  ...
                  , r = i.dir;
                Ze.cancel(this.$el),
                Ve(this.$el, this.getCss(uo(e, r, n)))
            }
        }]
    };
    function lo(t) {
    ...
    var co, fo, po = G({}, Dr, {
        ...
        update: {
            write: function() {
                if (this.clsEmpty && He(this.$el, this.clsEmpty, O(this.$el.children)),
                Ve(this.handle ? Ne(this.handle, this.$el) : this.$el.children, {
                    touchAction: "none",
                    userSelect: "none"
                }),
                this.drag) {
                    var t = si(window)
                      ...
                      , i = t.bottom;
                    si(this.drag, {
                        top: tt(this.pos.y + this.origin.top, 0, i - this.drag.offsetHeight),
                        left: tt(this.pos.x + this.origin.left, 0, e - this.drag.offsetWidth)
                    })
                }
            }
        },
        methods: {
            init: function(t) {
                ...
                !r || n || 0 < i || Rt(e) || Yt(e, "." + this.clsNoDrag) || this.handle && !Yt(e, this.handle) || (t.preventDefault(),
                this.touched = [this],
                this.placeholder = r,
                this.origin = G({
                    target: e,
            ...
            start: function(t) {
                ...
                i = this.placeholder,
                Ve(n = we(e, i.outerHTML.replace(/(^<)li|li(\/>$)/g, "$1div$2")), G({
                    boxSizing: "border-box",
                    width: i.offsetWidth,
                    height: i.offsetHeight,
                    overflow: "hidden"
                }, Ve(i, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))),
                ui(n.firstElementChild, ui(i.firstElementChild)),
                n);
                var r, o = si(this.placeholder), s = o.left, a = o.top;
                G(this.origin, {
                    left: s - this.pos.x,
                    top: a - this.pos.y
                }),
                ...
                co = setInterval(function() {
                    var t = r.x
                      , a = r.y;
                    Li(document.elementFromPoint(t - window.pageXOffset, a - window.pageYOffset)).some(function(t) {
                        var e = t.scrollTop
                          , i = t.scrollHeight
                          , n = si(Fi(t))
                          , r = n.top
            ...
            move: function(t) {
                if (this.drag) {
                    ...
                    var e = "mousemove" === t.type ? t.target : document.elementFromPoint(this.pos.x - window.pageXOffset, this.pos.y - window.pageYOffset)
                      ...
                      , r = i !== n;
                    if (i && !Yt(e, this.placeholder) && (!r || i.group && i.group === n.group)) {
                        if (e = i.$el === e.parentNode && e || Ot(i.$el).filter(function(t) {
                            return Yt(e, t)
                        })[0],
                        r)
                ...
                if (Xt(document, mt, this.move),
                Xt(document, gt, this.end),
                Xt(window, "scroll", this.scroll),
                this.drag) {
                    clearInterval(co);
                    var e = this.getSortable(this.placeholder);
                    this === e ? this.origin.index !== pe(this.placeholder) && Kt(this.$el, "moved", [this, this.placeholder]) : (Kt(e.$el, "added", [e, this.placeholder]),
            ...
            insert: function(i, n) {
                ...
                function t() {
                    var t, e;
                    n ? (!Yt(i, r.$el) || (e = n,
                    (t = i).parentNode === e.parentNode && pe(t) > pe(e)) ? be : xe)(n, i) : we(r.$el, i)
                }
                this.animation ? this.animate(t) : t()
            },
            remove: function(t) {
                Yt(t, this.$el) && (Ve(this.handle ? Ne(this.handle, t) : t, {
                    touchAction: "",
                    userSelect: ""
                }),
    ...
    var vo = []
      , wo = {
        ...
        methods: {
            ...
            hide: function() {
                this.isActive() && !Mt(this.$el, "input:focus") && (vo.splice(vo.indexOf(this), 1),
                clearTimeout(this.showTimer),
            ...
            _show: function() {
                this.tooltip = we(this.container, '<div class="' + this.clsPos + '" aria-expanded="true" aria-hidden> <div class="' + this.clsPos + '-inner">' + this.title + "</div> </div>"),
                this.positionAt(this.tooltip, this.$el),
                this.origin = "y" === this.getAxis() ? vi(this.dir) + "-" + this.align : this.align + "-" + vi(this.dir),
      ...
      , bo = {
        ...
        events: {
            change: function(t) {
                Mt(t.target, 'input[type="file"]') && (t.preventDefault(),
            ...
            drop: function(t) {
                ...
                e && e.files && (De(this.$el, this.clsDragover),
                this.upload(e.files))
            },
                      ...
                      , o = function(t) {
                        ...
                        ce(n.url, {
                            ...
                            beforeSend: function(t) {
                                var e = t.xhr;
                                e.upload && Ut(e.upload, "progress", n.progress),
                                ["loadStart", "load", "loadEnd", "abort"].forEach(function(t) {
                                    return Ut(e, t.toLowerCase(), n[t])
                                }),
                                n.beforeSend(t)
                            }
                        }).then(function(t) {
        ...
        fe(function() {
            ...
            Ut(document, pt, function(t) {
                ...
                ne(t)) {
                    ...
                    "touchstart" == pt && (Ve(document.body, "cursor", "pointer"),
                    Gt(document, gt + " " + bt, function() {
                        return setTimeout(function() {
                            return Ve(document.body, "cursor", "")
                        }, 50)
                    }))
                }
            }, {
    ...
    $o = (ko = qi).connect,
    Io = ko.disconnect,
    "MutationObserver"in window && xi.read(function() {
        document.body && Ae(document.body, $o);
